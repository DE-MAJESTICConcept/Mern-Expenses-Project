...
import {
  FaMoneyBillWave,
  FaRegCalendarAlt, // This icon isn't used in your current JSX, but keeping it in imports just in case
  FaSignInAlt,
  FaList,
  FaChartPie,
  FaQuoteLeft,
...
const HeroSection = () => {
  return (
    <>
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-purple-700 to-teal-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-purple-700 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
      ...
      <div className="py-20 px-4">
        ...
        <div className="mt-10 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Step 3 */}
          <div className="flex flex-col items-center text-center">
            <div className="p-4 rounded-full bg-orange-400 text-white mb-4"> {/* Changed yellow to orange for better contrast */}
